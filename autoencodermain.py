...
for img in train:
    img = load_img(img, target_size=(1020,1020))
...
def autoencoder():
    input_img = Input(shape=(1020,1020,3), name='image_input')
...
for img in test_list:
    img = np.reshape(img, (1,1020,1020,3))
...
for img in predicted_list:
    img = np.reshape(img, (1020,1020,3))
